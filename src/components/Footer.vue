...
<!-- Footer -->
<footer class="text-center text-lg-start text-muted" style="background-color:#A27459; color:white">
    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <p><i class="fas fa-home me-3 text-secondary"></i>10338 Ntabesinayi,Lower Crossroad</p>
          <p>
            <i class="fas fa-envelope me-3 text-secondary"></i>
           sisiphopepengweni@gmail.com
          </p>
          <p><i class="fas fa-phone me-3 text-secondary"></i> +27 63 537 5458</p>
        </div>
        <!-- Grid column -->
      </div>
      <!-- Grid row -->
